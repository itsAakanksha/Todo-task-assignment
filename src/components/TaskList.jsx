...
export default function TaskList() {
  // Get all todos from Redux state using useSelector hook
  ...
  return (
    <>
      <h2 className="m-4 text-xl ">Todos</h2>
      <ul className="list-none">
        {/* Loop through todos and render each todo item */}
        {todos.map((todo) => (
          <li
            className="mt-4 flex justify-between items-center bg-[#1b2857] px-4 py-2 rounded"
            key={todo.id}
          >
